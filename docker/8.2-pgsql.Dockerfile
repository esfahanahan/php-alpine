...
LABEL org.opencontainers.image.title="PHP 8.2 with PostgreSQL, Composer, Tasker, and Supervisor"
LABEL org.opencontainers.image.description="PHP 8.2 with PostgreSQL, Composer, Tasker, and Supervisor including extensions: (bcmath, bz2, exif, gd, gmp, intl, mysqli, opcache, pcntl, pdo, pdo_pgsql, sockets, xml, zip, inotify, exif, memcached, redis) based on php:8.2-cli-alpine3.20"
